...
typedef struct script_command {
  ...
  struct script_var *input_from;   /* NULL or a variable to provide input */
  struct script_var *output_to;    /* NULL or a variable to receive output */
  struct script_var *pid_to;       /* NULL or a variable */
  void *extra_data;                /* for your use; initialized to NULL */
} script_command;
